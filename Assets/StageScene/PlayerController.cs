...
public class PlayerController : MonoBehaviour
{
    ...
    {
        audioSource.PlayOneShot(spit);                     // 원거리 공격 오디오 재생
    ...
    IEnumerator ExecuteSpecialSkill()
    {
        ...
        audioSource.PlayOneShot(ulti);                     // 개미 살충기 공격 오디오 재생
    ...
    {
        audioSource.PlayOneShot(sword_se);                     // 강화 근거리 공격 오디오 재생
    ...
    {
        audioSource.PlayOneShot(sword_se);                     // 근거리 공격 오디오 재생
    ...
    void ShootSword()
    {
        audioSource.PlayOneShot(sword_se);                     // 강화 원거리 공격 오디오 재생
